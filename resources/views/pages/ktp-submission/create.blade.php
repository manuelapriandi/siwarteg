...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Buat Pengajuan KTP Baru</h1>
</div>
...
<div class="row">
    <div class="col">
        <form action="/ktp-submission" method="post" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="notes" id="notes" cols="30" rows="5" class="form-control @error('notes') is-invalid @enderror">{{ old('notes') }}</textarea>
                        @error('notes')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
